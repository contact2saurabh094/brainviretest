                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6" id="nameerror">
                                <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ old('name') }}" placeholder="Name" data-validation="required" data-validation-error-msg-container="#nameerror" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6" id="emailaerror">
                                <input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" placeholder="example@example.com" data-validation="email" data-validation-error-msg-container="#emailaerror">
